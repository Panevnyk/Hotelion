...
public enum AuthRestApiMethods: RestApiMethod {
    ...
    case currentUser
    case signout
    case createOrUpdateFullUserInfoURL(CreateOrUpdateFullUserInfoParameters)
    ...
    private static let createOrUpdateFullUserInfoURL = "/api/users/createOrUpdateFullUserInfo"
    ...
    public var data: RestApiData {
        ...
        case .signout:
            return RestApiData(url: RestApiConstants.baseURL + AuthRestApiMethods.signoutURL,
                               httpMethod: .post)
        case .createOrUpdateFullUserInfoURL(let parameters):
            return RestApiData(url: RestApiConstants.baseURL + AuthRestApiMethods.createOrUpdateFullUserInfoURL,
                               httpMethod: .post,
